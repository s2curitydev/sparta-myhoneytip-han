...
export default function MainPage({ navigation, route }) {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      firebase_db
        ...
        .once("value")
        .then((snapshot) => {
          console.log("Data has deliverd from the FireBase!!");
  ...
  const getLocation = async () => {
    ...
    try {
      ...
      Alert.alert("Can't found the location.", "Retry?");
    }
  };
    ...
    */
    <ScrollView style={styles.container}>
      ...
      >
        ...
        >
          <Text style={styles.middleButtonTextAll}>All</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.middleButtonWeb}
          onPress={() => {
            category("Web");
          }}
        >
          <Text style={styles.middleButtonText}>Web</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.middleButtonSproject}
          onPress={() => {
            category("S-project");
          }}
        >
          <Text style={styles.middleButtonText}>S-project</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.middleButtonMedia}
          onPress={() => {
            category("Media");
          }}
        >
          <Text style={styles.middleButtonText}>Media</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  middleButtonSproject: {
    width: 100,
    height: 50,
    padding: 15,
    backgroundColor: "#B351E8",
    borderColor: "deeppink",
    borderRadius: 15,
    margin: 7,
  },
